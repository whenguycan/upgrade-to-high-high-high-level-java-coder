## springboot项目集成RabbitMQ测试消费者不公平分发消费消息
...
消费者1在每次消费都会sleep3秒钟，效率比较差，而消费者2是一直在工作的，性能比较好，当我们启动消费者的时候，会发现大部分的消息都被消费者2消费的！不公平分发确实工作了！
