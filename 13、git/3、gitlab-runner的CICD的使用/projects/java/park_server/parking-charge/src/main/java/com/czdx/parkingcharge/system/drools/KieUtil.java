package com.czdx.parkingcharge.system.drools;
...
public class KieUtil {
    ...
    public static void addRule(String content, String name) {
        ...
        kieHelper.addContent(content, name + "." + ResourceType.DRL.getDefaultExtension());
//        kieHelper.addResource(ResourceFactory.newByteArrayResource(content.getBytes(StandardCharsets.UTF_8)), ResourceType.DRL);
    }
