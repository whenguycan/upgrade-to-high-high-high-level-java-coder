...
public class AsyncFactory
{
     ...
     * 操作日志记录
     *
     * @param validChannelVo 操作日志信息
     * @return 任务task
     */
    public static TimerTask sendPassageMessage(final String passageId,final ValidChannelVo validChannelVo) {
        return new TimerTask() {
            @Override
            public void run() {
                try {
                    WebSocketServerEntryPool.sendMessageByPassageId(passageId, validChannelVo);
                } catch (IOException e) {
