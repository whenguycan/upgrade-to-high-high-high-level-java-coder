...
public interface TExemptOrderMapper extends BaseMapper<TExemptOrder> {
    ...
    List<UnusualOrderVO> queryUnusualOrderVOCondition(@Param(Constants.WRAPPER) QueryWrapper<TExemptOrder> qw);
}
