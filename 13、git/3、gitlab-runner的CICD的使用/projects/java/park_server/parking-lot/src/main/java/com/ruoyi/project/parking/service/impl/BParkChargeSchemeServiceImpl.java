...
public class BParkChargeSchemeServiceImpl implements IBParkChargeSchemeService
{
    ...
    public int insertBParkChargeScheme(BParkChargeScheme bParkChargeScheme)
    {
        ...
        int row = bParkChargeSchemeMapper.insertBParkChargeScheme(bParkChargeScheme);
        if (row > 0) {
            pCGrpcClientService.refreshParkLotChargeScheme(bParkChargeScheme.getParkNo());
        }
        return row;
    }
    ...
    public int updateBParkChargeScheme(BParkChargeScheme bParkChargeScheme)
    {
        ...
        int row = bParkChargeSchemeMapper.updateBParkChargeScheme(bParkChargeScheme);
        if (row > 0) {
            pCGrpcClientService.refreshParkLotChargeScheme(bParkChargeScheme.getParkNo());
        }
        return row;
