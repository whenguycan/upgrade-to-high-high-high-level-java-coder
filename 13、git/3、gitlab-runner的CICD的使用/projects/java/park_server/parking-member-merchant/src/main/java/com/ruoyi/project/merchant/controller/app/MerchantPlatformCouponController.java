...
public class MerchantPlatformCouponController extends BaseController {
    ...
    public AjaxResult couponNumCollection() {
        ...
        tCouponType.setUserId(tCouponDetailVo.getUserId());
        AjaxResult ajaxResult = new AjaxResult();
        ajaxResult.put("ownAmount", createdList.size());
        ajaxResult.put("created", tCouponTypeService.countCouponType(tCouponDetailVo.getUserId(), tCouponDetailVo.getParkNo()));
    ...
    public AjaxResult merchantAccount() {
        ...
        //可提现的金额
        accountVo.setDisposableAmount(accountService.getDisposableAmount(accountVo));
        //冻结状态
