...
import com.ruoyi.project.merchant.domain.vo.CouponReportResultVo;
...
public interface TCouponDetailMapper extends BaseMapper<TCouponDetail> {
    ...
    List<MemberCouponVO> selectMemberCouponVOListByCarNumber(String carNumber);

    List<MemberCouponVO> selectMemberCouponVOBatchByCode(List<String> codes);

    List<CouponReportResultVo> selectCouponReportList(CouponReportParam param);
}
