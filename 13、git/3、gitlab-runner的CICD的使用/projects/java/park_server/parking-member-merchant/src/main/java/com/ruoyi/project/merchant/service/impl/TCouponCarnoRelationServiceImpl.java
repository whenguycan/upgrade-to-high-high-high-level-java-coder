...
public class TCouponCarnoRelationServiceImpl implements ITCouponCarnoRelationService {
    ...
    public int insertTCouponCarnoRelation(TCouponCarnoRelationVo tCouponCarnoRelation) {
        ...
        tCouponDetail.setValidStartTime(tCouponCarnoRelation.getValidStartTime());
        tCouponDetail.setValidEndTime(tCouponCarnoRelation.getValidEndTime());
    ...
    public int addCarUserCouponInfo(CarUserCoupon carUserCoupon) {
        itCouponDetailService.updateCouponUsedByCode(carUserCoupon.getTCouponDetail());
        return tCouponCarnoRelationMapper.insertTCouponCarnoRelation(carUserCoupon.getCouponCarnoRelation());
    }
