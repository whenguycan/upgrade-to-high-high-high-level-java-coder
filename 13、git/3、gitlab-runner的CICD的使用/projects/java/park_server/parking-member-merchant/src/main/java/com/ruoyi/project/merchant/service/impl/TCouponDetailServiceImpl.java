...
import com.ruoyi.project.common.SnowflakeIdWorker;
...
public class TCouponDetailServiceImpl extends ServiceImpl<TCouponDetailMapper, TCouponDetail> implements ITCouponDetailService {
    ...
    @Resource
    SnowflakeIdWorker16Size snowflakeIdWorker16Size;
    ...
    public boolean batchEditCoupon(OrderCouponVo orderCouponVo) {
        ...
        for (TCouponDetail tCouponDetail : tCouponDetails) {
            ...
            orderCouponVo.setUnitValue(tCouponDetail.getCouponPrice());
     ...
     */
    @Override
    public List<TCouponDetailVo> selectTCouponDetailList(TCouponDetailVo tCouponDetail) {
    ...
    public int insertTCouponDetail(TCouponDetail tCouponDetail) {
        tCouponDetail.setCouponCode(String.valueOf(snowflakeIdWorker16Size.nextId()));
    ...
    @Override
    public int updateCouponUsedByCode(TCouponDetail tCouponDetail) {
        return tCouponDetailMapper.updateCouponUsedByCode(tCouponDetail);
    }
    ...
    @Override
    public List<MemberCouponVO> selectMemberCouponVOListByCarNumber(String carNumber) {
        return tCouponDetailMapper.selectMemberCouponVOListByCarNumber(carNumber);
    }
    ...
    public boolean verifyCouponBatchByCouponCode(List<String> couponCodeList) {
        ...
        qw.in(TCouponDetail::getCouponCode, couponCodeList)
                .gt(TCouponDetail::getValidEndTime, LocalDateTime.now())
                .eq(TCouponDetail::getCouponStatus, CouponStatusEnum.ALLOCATED.getValue());
        return couponCodeList.size() == this.baseMapper.selectCount(qw);
    }

    @Override
    public List<MemberCouponVO> selectMemberCouponVOBatchByCode(List<String> codes) {
        return tCouponDetailMapper.selectMemberCouponVOBatchByCode(codes);
    }

    @Override
    public List<CouponReportResultVo> selectCouponReportList(CouponReportParam param) {
        return tCouponDetailMapper.selectCouponReportList(param);
    }
}
