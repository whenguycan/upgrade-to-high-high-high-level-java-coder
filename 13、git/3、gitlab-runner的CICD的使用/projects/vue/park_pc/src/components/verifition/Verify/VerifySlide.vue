  ...
  methods: {
    init () {
      ...
      window.addEventListener('touchmove', function (e) {
        if (e.view.location.origin !== window.location.origin) return
        _this.move(e)
      })
    ...
    start: function (e) {
      ...
      if (this.isEnd == false) {
        this.text = ''
        this.moveBlockBackgroundColor = '#80C0FF'
        this.leftBarBorderColor = '#80C0FF'
        this.iconColor = '#fff'
        e.stopPropagation()
        this.status = true
      }
      ...
      if (this.status && this.isEnd == false) {
        ...
        reqCheck(data).then(res => {
          if (res.repCode == '0000') {
            ...
            this.moveBlockBackgroundColor = '#e5908e'
            this.leftBarBorderColor = '#e5908e'
            this.iconColor = '#fff'
