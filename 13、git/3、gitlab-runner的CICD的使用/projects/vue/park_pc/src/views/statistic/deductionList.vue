 ...
 * @Description: 抵扣记录
 * @Author: cuijing
 * @Date: 2023-03-10 08:51:36
 * @LastEditors: cuijing
 * @LastEditTime: 2023-03-15 17:51:52
 * @文件相对于项目的路径: \park_pc\src\views\statistic\deductionList.vue
-->
<template>
  <div class="deductionList">
    <div class="deductionBox" style="width:100%;">
      ...
      <div class="tableBox">
        <el-table v-loading="loading" :data="tableData">
          ...
          <el-table-column label="出场时间" min-width="220" align="center" prop="exitTime">
            <template slot-scope="scope">
              {{ scope.row.exitTime |  chatTime}}
            </template>
          </el-table-column>
          <el-table-column label="停留时长" min-width="220" align="center" prop="durationTime">
          </el-table-column>
          <el-table-column label="应付总额(元)" min-width="220" align="center" prop="payableAmount">
          </el-table-column>
          <el-table-column label="实付总额(元)" min-width="220" align="center" prop="payAmount">
          </el-table-column>
          <el-table-column label="抵扣金额(元)" min-width="220" align="center" prop="unusualType">
          </el-table-column>
          <el-table-column label="抵扣原因" min-width="220" align="center" prop="unusualReason">
          </el-table-column>
...
import { getDeductionList } from "@/views/statistic/api/deductionList.js"
export default {
  name: 'deductionList',
  components: {
    titleTab
  ...
  methods: {
    ...
    async getList () {
      ...
      let res = await getDeductionList(param)
      if (res.code == 200) {
    ...
    // 导出
    handleExport () {
      this.download('parking/deductionorder/export', {
        ...this.queryForm
      }, `deduction_${new Date().getTime()}.xlsx`)
    },
  },
  created () {
...
.deductionList ::v-deep .el-form-item {
  display: flex;
}

.deductionList ::v-deep .el-form-item__content {
