 ...
 * @LastEditors: cuijing
 * @LastEditTime: 2023-03-15 17:50:54
 * @文件相对于项目的路径: \park_pc\src\views\statistic\derateList.vue
-->
<template>
  <div class="derateList">
    <div class="derateBox" style="width:100%;">
      ...
      <div class="tableBox">
        <el-table v-loading="loading" :data="tableData">
          ...
          <el-table-column label="减免金额(元)" min-width="220" align="center" prop="unusualType">
          </el-table-column>
          <el-table-column label="减免原因" min-width="220" align="center" prop="unusualReason">
          </el-table-column>
...
import { getDerateList } from "@/views/statistic/api/derateList.js"
export default {
  name: 'derateList',
  components: {
    titleTab
  ...
  methods: {
    ...
    async getList () {
      ...
      let res = await getDerateList(param)
      if (res.code == 200) {
    ...
    // 导出
    handleExport () {
      this.download('parking/exemptorder/export', {
        ...this.queryForm
      }, `derate_${new Date().getTime()}.xlsx`)
    },
  },
  created () {
...
.derateList ::v-deep .el-form-item {
  display: flex;
}

.derateList ::v-deep .el-form-item__content {
