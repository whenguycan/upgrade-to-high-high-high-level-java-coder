...
@Component
public class IccEventSubscribe {
...
//    private String _port="8080";
    ...
    public void eventSubscribe() throws ClientException {
        ...
        String monitorEntry = "http://"+ip +":"+ _port + "/SiteInfo/getEntrySiteInfo";
        String monitorLeave = "http://"+ip +":"+ _port + "/SiteInfo/getLeaveSiteInfo";
