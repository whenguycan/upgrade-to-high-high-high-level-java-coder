...
/**
 * 车辆离场记录对象 t_exit_records
 *
 * @author mzl
 * @date 2023-02-22
 */
@ApiModel(value = "车辆离场记录", description = "")
@Data
@TableName("t_exit_records")
public class TExitRecords  implements Serializable {
     ...
     */
    @Excel(name = "离场图片存储路径")
    @ApiModelProperty(value = "离场图片存储路径")
