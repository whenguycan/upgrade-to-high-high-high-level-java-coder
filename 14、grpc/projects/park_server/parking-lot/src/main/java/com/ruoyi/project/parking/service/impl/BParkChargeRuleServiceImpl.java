...
import com.czdx.grpc.lib.charge.ParkingChargeServiceGrpc;
import com.czdx.grpc.lib.charge.TestChargeParkingRuleRequest;
import com.czdx.grpc.lib.charge.TestChargeParkingRuleResponse;
...
public class BParkChargeRuleServiceImpl implements IBParkChargeRuleService
{
     ...
     */
    @Override
    public List<BParkChargeRuleVO> selectBParkChargeRuleList(BParkChargeRule bParkChargeRule)
    {
        List<BParkChargeRuleVO> data = new ArrayList<>();
        List<BParkChargeRule> ruleList = bParkChargeRuleMapper.selectBParkChargeRuleList(bParkChargeRule);
        if (CollectionUtils.isNotEmpty(ruleList)) {
            BParkChargeRuleVO vo;
            for (BParkChargeRule rule : ruleList) {
                vo = new BParkChargeRuleVO();
                BeanUtils.copyProperties(rule, vo);
                this.buildVO(vo);
                data.add(vo);
            }
    ...
    public int deleteBParkChargeRuleByIds(Integer[] ids)
    {
        ...
        return bParkChargeRuleMapper.deleteBParkChargeRuleByIds(ids);
    }
    ...
    public int deleteBParkChargeRuleById(Integer id)
    {
        ...
        return bParkChargeRuleMapper.deleteBParkChargeRuleById(id);
    }
    ...
    public double testParkRate(BParkChargeRuleTestParam bParkChargeRuleTestParam) {
        ...
        try {
            ...
            result = ruleResponse.getPayableAmount();
